...
#Resiko ini berupa tidak bisa dibayarkannya pokok dan bunga pinjaman, sehingga mengakibatkan kerugian.
...
#Decision tree adalah struktur model untuk pengambilan keputusan dimana kita mengikuti alur dari suatu titik awal (yang disebut root node), kondisi-kondisi berikutnya, sampai mencapai kesimpulan.
    ...
    #Contoh Pemodelan Decision Tree dengan Machine Learnig
...
str(dataCreditRating)
    ...
    #Data Preparation untuk Input Variable
...
str(datafeed)
    ...
    #Mempersiapkan Training Set dan Testing Set
...
#Fungsi dari perintah set.seed ialah untuk melakukan seeding sehingga nilai random selalu sama di setiap versi R yang digunakan.
...
#Dataset yang diperlukan untuk menghasilkan model C5.0 ialah training set untuk input variables dan class variable
...
#3. Memahami Output dari Fungsi C5.0
...
summary(risk_rating_model)
    ...
    #Menganalisa Label Class Variable
...
#Dengan tingkat error 22.5 persen, model ini harusnya cukup layak digunakan. Dari confusion matrix juga terlihat banyak sekali yang diprediksi dengan benar, terutama untuk nilai risk_rating 4 dan 5.
